...
export function VideoClipBlock({
  clip,
  zoom,
  isSelected,
  onClick,
    ...
    <div
      ...
      style={{
        ...
        background: isSelected
          ? 'hsl(160 50% 45% / 0.4)'
          : 'hsl(160 50% 45% / 0.25)',
        border: `1px solid ${isSelected ? 'hsl(160 50% 45%)' : 'hsl(160 50% 45% / 0.5)'}`,
        boxShadow: isSelected ? '0 0 0 1px hsl(160 50% 45%)' : undefined,
      }}
      onMouseDown={handleMouseDown}
    >
      <Film className="w-3 h-3 flex-shrink-0" style={{ color: 'hsl(160 50% 60%)' }} />
      <span
        className="text-[9px] truncate"
        style={{ color: 'hsl(160 70% 80%)' }}
      >
        {clip.name}
      </span>
      <span
        className="text-[8px] ml-auto flex-shrink-0"
        style={{ color: 'hsl(160 50% 55%)' }}
      >
      ...
      {/* Right resize handle */}
      <div
        className="absolute top-0 bottom-0 w-1.5 cursor-ew-resize hover:bg-[hsl(160_50%_45%/0.5)]"
        style={{ right: 0 }}
